...
(function ($, icons, webChef) {
	...
	var iconModalTemplate =
		'<div class="modal hide fade" id="tx-icon-list-modal" style="z-index: 1051;" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="Icon List" aria-hidden="true">'+
					...
					'<div class="modal-footer">'+
						...
						'<button type="button" class="btn btn-success btn-icon-insert-button">Insert Icon</button>'+
					'</div>'+
		'</div>';
	...
	$(document).on("click", ".btn-icon-insert-button", function(){
  ...
  $(document).on("click",".tx-icons-list li",function(){
	...
	var iconSelector = function(options){
      ...
      ACTIVE_INPUT =  jQuery(this).prev().prev().prev();
